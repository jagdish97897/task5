...
function Register() {
  ...
  return (
    <>
      ...
      <div className='bg-white mt-11 p-3 rounded w-30'>
        <h2 className='mb-9'>Sign Up</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className='mc-3'>
            <label htmlFor="employee_id"><strong>employee_id:</strong></label>
            <input type="text" placeholder='Enter employee_id' name='employee_id'
             value={values.employee_id} required onChange={e => setValues({ ...values, employee_id: e.target.value })}
              className='form-control rounded-0' />
          </div>
