...
app.put('/update/:id', (req, res) => {
    ...
    const { employee_id, dept_name, category, location, salary } = req.body;
    const sql = "UPDATE task5_login SET employee_id = ?, dept_name = ?, category = ?, location = ?, salary = ? WHERE id = ?";
    conn.query(sql, [employee_id, dept_name, category, location, salary, id], (err, result) => {
...
// app.put('/update/:id', (req, res) => {
//     const id = req.params.id;
//     const { dept_name, category, location, salary } = req.body;
//     const sql = "UPDATE task5_login SET dept_name = ?, category = ?, location = ?, salary = ? WHERE id = ?";
//     conn.query(sql, [dept_name, category, location, salary, id], (err, result) => {
//         if (err) return res.json({ Error: "Update employee error in SQL" });
//         return res.json({ Status: "Success" });
//     });
// });
